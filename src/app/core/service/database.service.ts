...
export class DatabaseService {
  ...
  getCreateTable() {
    const sqls = [];
    sqls.push("CREATE TABLE IF NOT EXISTS contacts (id integer primary key AUTOINCREMENT, name varchar(100), email varchar(255), phone varchar(100), surname varchar(100), address varchar(255));");
    return sqls.join('\n');
  }

  executSQL(sql: string, params?: any[]) { 
